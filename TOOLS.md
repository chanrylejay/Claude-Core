...
| **Hooks** (`.claude/settings.json`) | push-guard (PreToolUse, blocks git push without GO file) · gauntlet-guard (Stop, blocks "done" without QA tokens) | Settings-file safety: `workflow/tool-playbook.md`. |
