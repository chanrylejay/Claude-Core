...
# Freelance sales playbook (absorbed Jul 24 2026; original txt stays in Downloads/Projects)
...
LLM inference (hardware). Full honest current skills: [[chan-skills-ledger]].
...
5 nuclear: full refund and exit. The ready-to-run sales system pack: HAWK v2.0 + the n8n
ARCHITECT PLAYBOOK v2 (txt in Downloads/Projects; private methodology, pointer only).
...
Make/Zapier/GHL?" → primary expertise is n8n; exposure only elsewhere. Always-mention
