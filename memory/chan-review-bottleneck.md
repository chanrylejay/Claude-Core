...
1. **Report in HIS language, never mine.** Describe every change as what he will SEE and WHERE: the screen, the card, the exact spot, in plain words, plus a screenshot. Never lead a report with a filename or a code term. He should be able to review from the report in a couple of minutes.
