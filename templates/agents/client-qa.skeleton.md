...
tools: 🔧 REPLACE with this environment's real read-only tools (browser/screenshot + file read; on lean-ctx machines the ctx_* set + Bash). Never write tools. An agent with tools it can't use fails silently.
---
